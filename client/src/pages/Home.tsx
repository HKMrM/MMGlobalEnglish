...
export default function Home() {
  ...
  return (
    <div className="min-h-screen" style={{ backgroundColor: "#F8FBFF" }}>
      ...
      {/* ── HERO ── */}
      <section className="relative min-h-screen flex items-center overflow-hidden mt-28">
        <div
        ...
        >
          <div className="max-w-3xl mx-auto">
            ...
            >
              ...
              <p className="font-body text-base leading-relaxed mb-5" style={{ color: "#1A2332" }}>
                At MM Global English, we guide students to sort through sources, develop genuine empathy in listening, understand multiple perspectives, and ultimately express their own well-reasoned views — with clarity, confidence, and conviction.
              </p>
