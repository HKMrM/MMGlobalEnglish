          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            >
              ...
              <div className="space-y-4 font-body text-base leading-relaxed" style={{ color: "#2C2C2C" }}>
                <p>
                  The Voice Academy HK was founded in Hong Kong with a simple but powerful conviction: that every young person has ideas worth sharing — and that the skills to share them well can be taught, nurtured, and developed at any age.
                </p>
                <p>
