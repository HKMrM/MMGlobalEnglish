  ...
  const pricingOptions = [
    ...
    },
    {
      ...
      features: [
        ...
        "Clearer reasoning and rebuttal skills",
    ...
    {
      title: "Competitive Private Coaching",
      rate: "HKD 800",
      period: "per hour · in person",
      description: "Advanced one-on-one preparation for competitive debate, public speaking, Model United Nations, World Scholar’s Cup, and related programmes.",
      features: [
        "Competition-focused strategy",
        "Advanced debate and public speaking",
        "MUN and World Scholar’s Cup preparation",
    ...
    {
      title: "Competitive Group Sessions",
      rate: "HKD 600",
      period: "per hour per student",
      description: "Small-group preparation for competitive debate, public speaking, MUN, and related programmes, with a minimum of three students.",
      features: [
        "Collaborative competition preparation",
        "Debate and discussion practice",
        "Peer feedback and support",
        "Group strategy and role practice",
          ...
          <div className="space-y-6">
            {[
              ...
              },
              {
                ...
                a: "We offer beginner private coaching for creative writing and young public speaking at HKD 550/hour, intermediate debate and public speaking coaching at HKD 650/hour, competitive private coaching in person at HKD 800/hour, and competitive group sessions at HKD 600/hour per student (3+ students). Online sessions are available for beginner and intermediate coaching. Remote in-person sessions may require a travel fee, which will be discussed in advance.",
              },
              {
